...
// End Cross Module References
	DEFINE_FUNCTION(APortal::execgetObj)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FString*)Z_Param__Result=P_THIS->getObj();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(APortal::execgetPee)
	{
		P_GET_UBOOL(Z_Param_penum);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(int32*)Z_Param__Result=P_THIS->getPee(Z_Param_penum);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(APortal::execrunTeleportation)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->runTeleportation();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(APortal::execcameraRotation)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->cameraRotation();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(APortal::execmovePlayer)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->movePlayer();
	...
	DEFINE_FUNCTION(APortal::execcameraAntiClip)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->cameraAntiClip();
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(APortal::execmoveItems)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->moveItems();
	...
	DEFINE_FUNCTION(APortal::execupdateOther)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->updateOther();
	...
	DEFINE_FUNCTION(APortal::execsyncPortals)
	{
		P_GET_UBOOL(Z_Param_syncState);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->syncPortals(Z_Param_syncState);
		P_NATIVE_END;
	}
	...
	static FName NAME_APortal_getPortalItems = FName(TEXT("getPortalItems"));
	void APortal::getPortalItems()
	{
		ProcessEvent(FindFunctionChecked(NAME_APortal_getPortalItems),NULL);
	}
	...
	static FName NAME_APortal_yelli = FName(TEXT("yelli"));
	void APortal::yelli()
	{
		ProcessEvent(FindFunctionChecked(NAME_APortal_yelli),NULL);
	}
	void APortal::StaticRegisterNativesAPortal()
	{
		UClass* Class = APortal::StaticClass();
		static const FNameNativePtrPair Funcs[] = {
			{ "cameraAntiClip", &APortal::execcameraAntiClip },
			{ "cameraRotation", &APortal::execcameraRotation },
			{ "getObj", &APortal::execgetObj },
			{ "getPee", &APortal::execgetPee },
			...
			{ "moveItems", &APortal::execmoveItems },
			{ "movePlayer", &APortal::execmovePlayer },
			{ "nearbySync", &APortal::execnearbySync },
			{ "runTeleportation", &APortal::execrunTeleportation },
	...
	struct Z_Construct_UFunction_APortal_cameraAntiClip_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APortal_cameraAntiClip_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Portal.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_APortal_cameraAntiClip_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_APortal, nullptr, "cameraAntiClip", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_APortal_cameraAntiClip_Statics::Function_MetaDataParams), Z_Construct_UFunction_APortal_cameraAntiClip_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_APortal_cameraAntiClip()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_APortal_cameraAntiClip_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_APortal_cameraRotation_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APortal_cameraRotation_Statics::Function_MetaDataParams[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "// This updates the position of capture cameras\n" },
#endif
		{ "ModuleRelativePath", "Portal.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "This updates the position of capture cameras" },
#endif
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_APortal_cameraRotation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_APortal, nullptr, "cameraRotation", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_APortal_cameraRotation_Statics::Function_MetaDataParams), Z_Construct_UFunction_APortal_cameraRotation_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_APortal_cameraRotation()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_APortal_cameraRotation_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_APortal_getObj_Statics
	{
		struct Portal_eventgetObj_Parms
		{
			FString ReturnValue;
		};
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_APortal_getObj_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Portal_eventgetObj_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_APortal_getObj_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_APortal_getObj_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APortal_getObj_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Portal.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_APortal_getObj_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_APortal, nullptr, "getObj", nullptr, nullptr, Z_Construct_UFunction_APortal_getObj_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_APortal_getObj_Statics::PropPointers), sizeof(Z_Construct_UFunction_APortal_getObj_Statics::Portal_eventgetObj_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_APortal_getObj_Statics::Function_MetaDataParams), Z_Construct_UFunction_APortal_getObj_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_APortal_getObj_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_APortal_getObj_Statics::Portal_eventgetObj_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_APortal_getObj()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_APortal_getObj_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_APortal_getPee_Statics
	{
		struct Portal_eventgetPee_Parms
		{
			bool penum;
			int32 ReturnValue;
		};
		static void NewProp_penum_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_penum;
	...
	void Z_Construct_UFunction_APortal_getPee_Statics::NewProp_penum_SetBit(void* Obj)
	{
		((Portal_eventgetPee_Parms*)Obj)->penum = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_APortal_getPee_Statics::NewProp_penum = { "penum", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(Portal_eventgetPee_Parms), &Z_Construct_UFunction_APortal_getPee_Statics::NewProp_penum_SetBit, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_APortal_getPee_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Portal_eventgetPee_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_APortal_getPee_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_APortal_getPee_Statics::NewProp_penum,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_APortal_getPee_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APortal_getPee_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Portal.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_APortal_getPee_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_APortal, nullptr, "getPee", nullptr, nullptr, Z_Construct_UFunction_APortal_getPee_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_APortal_getPee_Statics::PropPointers), sizeof(Z_Construct_UFunction_APortal_getPee_Statics::Portal_eventgetPee_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_APortal_getPee_Statics::Function_MetaDataParams), Z_Construct_UFunction_APortal_getPee_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_APortal_getPee_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_APortal_getPee_Statics::Portal_eventgetPee_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_APortal_getPee()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_APortal_getPee_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_APortal_getPortalItems_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APortal_getPortalItems_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Portal.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_APortal_getPortalItems_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_APortal, nullptr, "getPortalItems", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_APortal_getPortalItems_Statics::Function_MetaDataParams), Z_Construct_UFunction_APortal_getPortalItems_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_APortal_getPortalItems()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_APortal_getPortalItems_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_APortal_moveItems_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APortal_moveItems_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Portal.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_APortal_moveItems_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_APortal, nullptr, "moveItems", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_APortal_moveItems_Statics::Function_MetaDataParams), Z_Construct_UFunction_APortal_moveItems_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_APortal_moveItems()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_APortal_moveItems_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_APortal_movePlayer_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APortal_movePlayer_Statics::Function_MetaDataParams[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "// This moves the player, will be replaced with a more permanent solution\n" },
#endif
		{ "ModuleRelativePath", "Portal.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "This moves the player, will be replaced with a more permanent solution" },
#endif
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_APortal_movePlayer_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_APortal, nullptr, "movePlayer", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_APortal_movePlayer_Statics::Function_MetaDataParams), Z_Construct_UFunction_APortal_movePlayer_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_APortal_movePlayer()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
	...
	struct Z_Construct_UFunction_APortal_runTeleportation_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APortal_runTeleportation_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Portal.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_APortal_runTeleportation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_APortal, nullptr, "runTeleportation", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_APortal_runTeleportation_Statics::Function_MetaDataParams), Z_Construct_UFunction_APortal_runTeleportation_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_APortal_runTeleportation()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_APortal_runTeleportation_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_APortal_syncPortals_Statics
	{
		struct Portal_eventsyncPortals_Parms
		{
			bool syncState;
		};
		static void NewProp_syncState_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_syncState;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	void Z_Construct_UFunction_APortal_syncPortals_Statics::NewProp_syncState_SetBit(void* Obj)
	{
		((Portal_eventsyncPortals_Parms*)Obj)->syncState = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_APortal_syncPortals_Statics::NewProp_syncState = { "syncState", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(Portal_eventsyncPortals_Parms), &Z_Construct_UFunction_APortal_syncPortals_Statics::NewProp_syncState_SetBit, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_APortal_syncPortals_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_APortal_syncPortals_Statics::NewProp_syncState,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APortal_syncPortals_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Portal.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_APortal_syncPortals_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_APortal, nullptr, "syncPortals", nullptr, nullptr, Z_Construct_UFunction_APortal_syncPortals_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_APortal_syncPortals_Statics::PropPointers), sizeof(Z_Construct_UFunction_APortal_syncPortals_Statics::Portal_eventsyncPortals_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_APortal_syncPortals_Statics::Function_MetaDataParams), Z_Construct_UFunction_APortal_syncPortals_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_APortal_syncPortals_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_APortal_syncPortals_Statics::Portal_eventsyncPortals_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_APortal_syncPortals()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_APortal_syncPortals_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_APortal_teleSync_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APortal_teleSync_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Portal.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_APortal_teleSync_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_APortal, nullptr, "teleSync", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_APortal_teleSync_Statics::Function_MetaDataParams), Z_Construct_UFunction_APortal_teleSync_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_APortal_teleSync()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_APortal_teleSync_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_APortal_updateOther_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APortal_updateOther_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Portal.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_APortal_updateOther_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_APortal, nullptr, "updateOther", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_APortal_updateOther_Statics::Function_MetaDataParams), Z_Construct_UFunction_APortal_updateOther_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_APortal_updateOther()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_APortal_updateOther_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_APortal_yelli_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APortal_yelli_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Portal.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_APortal_yelli_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_APortal, nullptr, "yelli", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_APortal_yelli_Statics::Function_MetaDataParams), Z_Construct_UFunction_APortal_yelli_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_APortal_yelli()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_APortal_yelli_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_portalCamDist_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_portalCamDist;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_shiftDegree_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_shiftDegree;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_defaultRelativePortalLocation_MetaData[];
#endif
		static const UECodeGen_Private::FStructPropertyParams NewProp_defaultRelativePortalLocation;
		static const UECodeGen_Private::FObjectPropertyParams NewProp_inPortal_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_inPortal_MetaData[];
#endif
		static const UECodeGen_Private::FArrayPropertyParams NewProp_inPortal;
		static const UECodeGen_Private::FObjectPropertyParams NewProp_inNearby_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_inNearby_MetaData[];
#endif
		static const UECodeGen_Private::FArrayPropertyParams NewProp_inNearby;
		static const UECodeGen_Private::FObjectPropertyParams NewProp_portalItems_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_portalItems_MetaData[];
#endif
		static const UECodeGen_Private::FArrayPropertyParams NewProp_portalItems;
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_APortal_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_APortal_cameraAntiClip, "cameraAntiClip" }, // 1668777658
		{ &Z_Construct_UFunction_APortal_cameraRotation, "cameraRotation" }, // 1505786413
		{ &Z_Construct_UFunction_APortal_getObj, "getObj" }, // 3774687617
		{ &Z_Construct_UFunction_APortal_getPee, "getPee" }, // 3973786205
		{ &Z_Construct_UFunction_APortal_getPortalItems, "getPortalItems" }, // 728143815
		...
		{ &Z_Construct_UFunction_APortal_moveItems, "moveItems" }, // 1599706417
		...
		{ &Z_Construct_UFunction_APortal_runTeleportation, "runTeleportation" }, // 91075107
		...
		{ &Z_Construct_UFunction_APortal_updateOther, "updateOther" }, // 3935346015
		{ &Z_Construct_UFunction_APortal_yelli, "yelli" }, // 3254341310
	};
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APortal_Statics::NewProp_portalCamDist_MetaData[] = {
		{ "Category", "PortalData" },
		{ "ModuleRelativePath", "Portal.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APortal_Statics::NewProp_portalCamDist = { "portalCamDist", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(APortal, portalCamDist), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_APortal_Statics::NewProp_portalCamDist_MetaData), Z_Construct_UClass_APortal_Statics::NewProp_portalCamDist_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APortal_Statics::NewProp_shiftDegree_MetaData[] = {
		{ "Category", "PortalData" },
		{ "ModuleRelativePath", "Portal.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APortal_Statics::NewProp_shiftDegree = { "shiftDegree", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(APortal, shiftDegree), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_APortal_Statics::NewProp_shiftDegree_MetaData), Z_Construct_UClass_APortal_Statics::NewProp_shiftDegree_MetaData) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APortal_Statics::NewProp_defaultRelativePortalLocation_MetaData[] = {
		{ "Category", "PortalData" },
		{ "ModuleRelativePath", "Portal.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_APortal_Statics::NewProp_defaultRelativePortalLocation = { "defaultRelativePortalLocation", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(APortal, defaultRelativePortalLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_APortal_Statics::NewProp_defaultRelativePortalLocation_MetaData), Z_Construct_UClass_APortal_Statics::NewProp_defaultRelativePortalLocation_MetaData) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_APortal_Statics::NewProp_inPortal_Inner = { "inPortal", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APortal_Statics::NewProp_inPortal_MetaData[] = {
		{ "Category", "PortalData" },
		{ "ModuleRelativePath", "Portal.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_APortal_Statics::NewProp_inPortal = { "inPortal", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(APortal, inPortal), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_APortal_Statics::NewProp_inPortal_MetaData), Z_Construct_UClass_APortal_Statics::NewProp_inPortal_MetaData) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_APortal_Statics::NewProp_inNearby_Inner = { "inNearby", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APortal_Statics::NewProp_inNearby_MetaData[] = {
		{ "Category", "PortalData" },
		{ "ModuleRelativePath", "Portal.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_APortal_Statics::NewProp_inNearby = { "inNearby", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(APortal, inNearby), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_APortal_Statics::NewProp_inNearby_MetaData), Z_Construct_UClass_APortal_Statics::NewProp_inNearby_MetaData) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_APortal_Statics::NewProp_portalItems_Inner = { "portalItems", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APortal_Statics::NewProp_portalItems_MetaData[] = {
		{ "Category", "PortalData" },
		{ "ModuleRelativePath", "Portal.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_APortal_Statics::NewProp_portalItems = { "portalItems", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(APortal, portalItems), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_APortal_Statics::NewProp_portalItems_MetaData), Z_Construct_UClass_APortal_Statics::NewProp_portalItems_MetaData) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_APortal_Statics::NewProp_nearbyItems_Inner = { "nearbyItems", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APortal_Statics::NewProp_nearbyItems_MetaData[] = {
		{ "Category", "PortalData" },
		{ "ModuleRelativePath", "Portal.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_APortal_Statics::NewProp_nearbyItems = { "nearbyItems", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(APortal, nearbyItems), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_APortal_Statics::NewProp_nearbyItems_MetaData), Z_Construct_UClass_APortal_Statics::NewProp_nearbyItems_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_APortal_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APortal_Statics::NewProp_portalCamDist,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APortal_Statics::NewProp_shiftDegree,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APortal_Statics::NewProp_defaultRelativePortalLocation,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APortal_Statics::NewProp_inPortal_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APortal_Statics::NewProp_inPortal,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APortal_Statics::NewProp_inNearby_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APortal_Statics::NewProp_inNearby,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APortal_Statics::NewProp_portalItems_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APortal_Statics::NewProp_portalItems,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APortal_Statics::NewProp_nearbyItems_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APortal_Statics::NewProp_nearbyItems,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_david_silverman_source_UnrealPortals_UnrealPortals_Source_UnrealPortals_Portal_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_APortal, APortal::StaticClass, TEXT("APortal"), &Z_Registration_Info_UClass_APortal, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APortal), 2001975687U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_david_silverman_source_UnrealPortals_UnrealPortals_Source_UnrealPortals_Portal_h_390826926(TEXT("/Script/UnrealPortals"),
