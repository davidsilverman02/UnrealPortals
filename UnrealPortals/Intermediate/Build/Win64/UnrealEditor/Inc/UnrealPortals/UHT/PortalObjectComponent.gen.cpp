...
// End Cross Module References
	DEFINE_FUNCTION(UPortalObjectComponent::execsetIsPlayer)
	{
		P_GET_UBOOL(Z_Param_newPlayer);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->setIsPlayer(Z_Param_newPlayer);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UPortalObjectComponent::execgetIsPlayer)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=P_THIS->getIsPlayer();
		P_NATIVE_END;
	}
	...
	{
		UClass* Class = UPortalObjectComponent::StaticClass();
		static const FNameNativePtrPair Funcs[] = {
			{ "getIsPlayer", &UPortalObjectComponent::execgetIsPlayer },
			{ "setIsPlayer", &UPortalObjectComponent::execsetIsPlayer },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_UPortalObjectComponent_getIsPlayer_Statics
	{
		struct PortalObjectComponent_eventgetIsPlayer_Parms
		{
			bool ReturnValue;
		};
	...
	void Z_Construct_UFunction_UPortalObjectComponent_getIsPlayer_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((PortalObjectComponent_eventgetIsPlayer_Parms*)Obj)->ReturnValue = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UPortalObjectComponent_getIsPlayer_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(PortalObjectComponent_eventgetIsPlayer_Parms), &Z_Construct_UFunction_UPortalObjectComponent_getIsPlayer_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPortalObjectComponent_getIsPlayer_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPortalObjectComponent_getIsPlayer_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPortalObjectComponent_getIsPlayer_Statics::Function_MetaDataParams[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "// The getter and setter functions for isPlayer\n" },
#endif
		{ "ModuleRelativePath", "PortalObjectComponent.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "The getter and setter functions for isPlayer" },
#endif
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPortalObjectComponent_getIsPlayer_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPortalObjectComponent, nullptr, "getIsPlayer", nullptr, nullptr, Z_Construct_UFunction_UPortalObjectComponent_getIsPlayer_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPortalObjectComponent_getIsPlayer_Statics::PropPointers), sizeof(Z_Construct_UFunction_UPortalObjectComponent_getIsPlayer_Statics::PortalObjectComponent_eventgetIsPlayer_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPortalObjectComponent_getIsPlayer_Statics::Function_MetaDataParams), Z_Construct_UFunction_UPortalObjectComponent_getIsPlayer_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UPortalObjectComponent_getIsPlayer_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UPortalObjectComponent_getIsPlayer_Statics::PortalObjectComponent_eventgetIsPlayer_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_UPortalObjectComponent_getIsPlayer()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UPortalObjectComponent_getIsPlayer_Statics::FuncParams);
		}
	...
	struct Z_Construct_UFunction_UPortalObjectComponent_setIsPlayer_Statics
	{
		struct PortalObjectComponent_eventsetIsPlayer_Parms
		{
			bool newPlayer;
		};
		static void NewProp_newPlayer_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_newPlayer;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	void Z_Construct_UFunction_UPortalObjectComponent_setIsPlayer_Statics::NewProp_newPlayer_SetBit(void* Obj)
	{
		((PortalObjectComponent_eventsetIsPlayer_Parms*)Obj)->newPlayer = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UPortalObjectComponent_setIsPlayer_Statics::NewProp_newPlayer = { "newPlayer", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(PortalObjectComponent_eventsetIsPlayer_Parms), &Z_Construct_UFunction_UPortalObjectComponent_setIsPlayer_Statics::NewProp_newPlayer_SetBit, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPortalObjectComponent_setIsPlayer_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPortalObjectComponent_setIsPlayer_Statics::NewProp_newPlayer,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPortalObjectComponent_setIsPlayer_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "PortalObjectComponent.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPortalObjectComponent_setIsPlayer_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPortalObjectComponent, nullptr, "setIsPlayer", nullptr, nullptr, Z_Construct_UFunction_UPortalObjectComponent_setIsPlayer_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPortalObjectComponent_setIsPlayer_Statics::PropPointers), sizeof(Z_Construct_UFunction_UPortalObjectComponent_setIsPlayer_Statics::PortalObjectComponent_eventsetIsPlayer_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPortalObjectComponent_setIsPlayer_Statics::Function_MetaDataParams), Z_Construct_UFunction_UPortalObjectComponent_setIsPlayer_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UPortalObjectComponent_setIsPlayer_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UPortalObjectComponent_setIsPlayer_Statics::PortalObjectComponent_eventsetIsPlayer_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_UPortalObjectComponent_setIsPlayer()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UPortalObjectComponent_setIsPlayer_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPortalObjectComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPortalObjectComponent_getIsPlayer, "getIsPlayer" }, // 1237759493
		...
		{ &Z_Construct_UFunction_UPortalObjectComponent_setIsPlayer, "setIsPlayer" }, // 2054402384
	};
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPortalObjectComponent_Statics::NewProp_isPlayer = { "isPlayer", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPortalObjectComponent), &Z_Construct_UClass_UPortalObjectComponent_Statics::NewProp_isPlayer_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPortalObjectComponent_Statics::NewProp_isPlayer_MetaData), Z_Construct_UClass_UPortalObjectComponent_Statics::NewProp_isPlayer_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_david_silverman_source_UnrealPortals_UnrealPortals_Source_UnrealPortals_PortalObjectComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPortalObjectComponent, UPortalObjectComponent::StaticClass, TEXT("UPortalObjectComponent"), &Z_Registration_Info_UClass_UPortalObjectComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPortalObjectComponent), 381205098U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_david_silverman_source_UnrealPortals_UnrealPortals_Source_UnrealPortals_PortalObjectComponent_h_3767987353(TEXT("/Script/UnrealPortals"),
